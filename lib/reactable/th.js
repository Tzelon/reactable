...
var Th = (function (_React$Component) {
    ...
    function Th() {
        ...
        _get(Object.getPrototypeOf(Th.prototype), 'constructor', this).call(this);
    ...
    _createClass(Th, [{
        ...
        value: function _onClickCallback() {
        ...
        value: function render() {
            ...
            if (this.state.showFilter) {
                return _react2['default'].createElement(
                    'th',
                    null,
                    _react2['default'].createElement('input', { type: 'text', placeholder: 'filter', onClick: this._onClickCallback })
                );
            } else {
                if ((0, _unsafe.isUnsafe)(this.props.children)) {
                    ...
                    return _react2['default'].createElement(
                        'th',
                        _extends({}, (0, _libFilter_props_from.filterPropsFrom)(this.props), { onClick: this._onClickCallback }),
                        this.props.children
                    );
                }
            }
